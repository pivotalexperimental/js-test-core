module JsTestCore
  class SeleniumServerConfiguration
    ...
    def query_string
      parts = [selenium_server_start_command, selenium_host, selenium_port]
    ...
    def selenium_server_start_command
      "selenium_server_start_command=#{parameter_or_default_for(:selenium_server_start_command, '*firefox')}"
    end
